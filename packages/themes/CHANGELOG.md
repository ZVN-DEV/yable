...
- 76b7ced: Column resize handles now render in a single overlay layer above the header
...
- dde51aa: Fix: the column-resize handle now sits ON the column divider instead of slightly left of it.
