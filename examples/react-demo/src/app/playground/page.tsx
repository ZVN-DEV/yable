...
function buildColumns(editable: boolean, showSelection: boolean): ColumnDef<Employee, any>[] {
  ...
  cols.push(
    ...
    columnHelper.accessor('active', {
      header: 'Active',
      cell: editable ? (info: any) => <CellCheckbox context={info} /> : undefined,
      cellType: 'boolean',
...
export default function PlaygroundPage() {
  ...
  const columns = useMemo(() => buildColumns(editMode, showSelection), [editMode, showSelection])
      ...
      <main className={s.stage}>
        <div className={s.stageHeader}>
          <div className={s.stageInfo}>
            <span className={s.stageThemeLabel}>
